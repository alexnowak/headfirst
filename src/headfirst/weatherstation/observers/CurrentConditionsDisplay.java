...
import headfirst.weatherstation.data.Subject;
...
public class CurrentConditionsDisplay implements Observer, DisplayElement {
	 ...
	 * WeatherData object.
	 * 
	 * @see headfirst.weatherstation.observers.DisplayElement#display()
	 */
	@Override
	public void display() {
	...
	/**
	 * @see headfirst.weatherstation.observers.Observer#update()
	 */
	@Override
